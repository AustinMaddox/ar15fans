	...
	if ($html_active) {
		...
		$links['main'] = array_merge( $links['main'],
			array(
				...
				'GYM_HTML_NEWS_LINK' => $display_html_main_links ? sprintf($gym_link_tpl, $html_news_url, 'html_news.png', $user->lang['HTML_NEWS']) : '',
				...
				'GYM_HTML_THEFORUM_NEWS_LINK' => sprintf($gym_link_tpl, $links['setup']['html']['forum_news_url'], 'html_news.png', $user->lang['HTML_FORUM_NEWS']),
